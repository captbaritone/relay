...
:::info
This document describes why the `@alias` directive was introduced, and how it can be used to improve type safety in your Relay applications. **To learn about it's API, see the [API Reference](../api-reference/graphql/graphql-directives.mdx#alias).**
:::
...
See the [@alias e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/queries/alias.md) for a runnable example.
