...
See the [commitMutation e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/mutations/commit-mutation.md) for a runnable example.
