...
See the [useSubscription e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/subscriptions/use-subscription.md) for a runnable example.
