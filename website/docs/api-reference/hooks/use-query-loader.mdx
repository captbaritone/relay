...
See the [useQueryLoader + usePreloadedQuery e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/queries/preloaded-query.md) for a runnable example.
