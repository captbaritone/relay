...
import FbEntrypointsExtraInfo from './fb/FbEntrypointsExtraInfo.mdx';
...
- [useLazyLoadQuery e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/queries/greeting.md)
- [usePreloadedQuery + useQueryLoader e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/queries/preloaded-query.md)
- [loadQuery e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/queries/load-query.md)
