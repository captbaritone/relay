...
- [@defer e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/incremental/defer.md)
- [@stream e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/incremental/stream.md)
