...
import FbSuspenseListAlternative from './fb/FbSuspenseListAlternative.mdx';
import FbRenderingConnectionsUsingSuspenseList from './fb/FbRenderingConnectionsUsingSuspenseList.mdx';
...
See the [Pagination e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/queries/pagination.md) for a runnable example.
