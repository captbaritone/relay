...
- [useMutation e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/mutations/mutation.md)
- [commitMutation e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/mutations/commit-mutation.md)
- [optimisticResponse e2e test](https://github.com/facebook/relay/blob/main/packages/relay-e2e-test/fixtures/mutations/optimistic-response.md)
